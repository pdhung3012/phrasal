 ...
 * @author Spence Green
 */
public class PhraseExtractForTestData {
  ...
  public PhraseExtractForTestData(Properties prop) throws IOException {
  ...
  public void init() {
    ...
    String[] featureExtractorList = prop.getProperty(FEATURE_EXTRACTORS_OPT, DEFAULT_FEATURE_SET)
        .split(PhraseExtractForTestData.FEATURE_EXTRACTOR_DELIM);
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      PhraseExtractForTestData e = new PhraseExtractForTestData(prop);
      e.extractAll();
    } catch (Exception e) {
      e.printStackTrace();
    }
